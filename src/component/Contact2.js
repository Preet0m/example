          ...
          <div className="column">
            <div className="icon-item">
              ...
              <div className="text">
                <h5>Our Address</h5>
                <p>
                  3rd floor, Adishakti Constructions, Fire Brigade Station, opposite of Fire Brigade Goaves, Shastri Nagar, Shahapur, Belagavi, Karnataka 590001
                </p>
              </div>
            </div>
            ...
            <div className="icon-item">
              ...
              <div className="text">
                <h5>Phone Number</h5>
                <p>+91 8971020906 / +91 9591211023 / +91 9742803658</p>
              </div>
            </div>
