            ...
            <div className="bbb">
              <ul className="add">
                <li>
                  ...
                  Goaves Khanapur Rd, Shastri Nagar, Belgaum
                </li>
                <li>
                ...
                <li>
                  ...
                  service@softmusk.com
                </li>
              </ul>
            </div>
            <div className="ccc">
              <ul className="add social-icons">
                <Link to="https://www.facebook.com/softmuskinfo/">
                  <li>
                    <FaFacebookF className="icon fb-icon" />
                  </li>
                </Link>
                <Link to="https://cleartax.in/f/company/softmusk-info-private-limited-/U72900KA2019PTC126345/">
                  <li>
                    <BsTwitter className="icon twitter-icon" />
                  </li>
                </Link>
                <Link to="https://in.linkedin.com/company/softmusk">
                  <li>
